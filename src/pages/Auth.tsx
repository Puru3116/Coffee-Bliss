        ...
        <form className="mt-8 space-y-6">
          {!isLogin && (
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-brown-500 focus:border-brown-500"
          ...
          {isLogin && (
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-sm font-medium text-brown-600 hover:text-brown-500"
              >
